...
set(ARCH "-march=armv4t -mthumb -mthumb-interwork -mlong-calls -Wl,--print-memory-usage,--gc-sections,-Map=${PROJECT_NAME}.map")
...
set(CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS} -s -Wl,--strip-all")
